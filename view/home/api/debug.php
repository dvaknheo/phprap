<?php include_view(['name'=>'home/public/header','title'=>'在线调试'])?>
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-default">
                        ...
                        <?php include_view(['name'=>'home/api/tab','tab'=>'debug'])?>
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-btn">
                                                <button style="width: 80px;" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><span class="js_methodName"><?=$api->request_method?></span> <span class="caret"></span></button>
                                                <input class="js_requestMethod" type="hidden" name="api[request_method]" value="<?=$api->request_method?>">
                                                <ul class="dropdown-menu">
                                                    <?php foreach($api->requestMethodLabels as $k => $method){?>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table" id="headerParamTable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select onchange="selectType(this)" name="header[type][]" class="form-control js_type">
                                                                <?php foreach($api->field->fieldTypeLabels as $k => $v){?>
                                                        ...
                                                        <td>
                                                            <select name="header[required][]" class="form-control">
                                                                <?php foreach($api->field->requiredLabels as $k => $v){?>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="addField(this, 'header')" href="javascript:;" class="btn btn-xs hidden-xs fa fa-fw fa-plus option-btn js_addField" data-toggle="tooltip" data-placement="bottom" data-title="添加子参数" <?php if(!$api->field->isCompositeType($header->type)){?>disabled<?php }?> data-parent_id="<?=$header->id?>"></a>
                                                        </td>
                                            ...
                                            <div class="table-responsive">
                                                <table class="table" id="requestParamTable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a onclick="deleteField(this)" href="javascript:;" class="btn btn-xs hidden-xs fa fa-fw fa-trash-o option-btn" data-toggle="tooltip" data-placement="bottom" data-title="删除参数"></a>
                                                            <a onclick="addField(this, 'request')" href="javascript:;" class="btn btn-xs hidden-xs fa fa-fw fa-plus option-btn js_addField" data-toggle="tooltip" data-placement="bottom" data-title="添加子参数" <?php if(!$api->field->isCompositeType($request->type)){?>disabled<?php }?> data-parent_id="<?=$request->id?>"></a>
                                                        </td>
    ...
    $(function(){
        ...
        $("form").validateForm({
            'success':function (json) {
                ...
                $('.response-body').jsonViewer(JSON.parse(json.body),options);
