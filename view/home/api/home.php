<?php include_view(['name'=>'home/public/header','title'=>'接口主页'])?>
            ...
            <div class="col-lg-12">
                <div class="page-header">
                    ...
                    <div class="opt-btn">
                        ...
                        <?php if($project->hasAuth(['api' => 'export']) || $project->hasAuth(['api' => 'delete'])){?>
                        <div class="btn-group hidden-xs ml-1">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                ...
                                <?php if($project->hasAuth(['api' => 'export'])){?>
                                <li>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="panel panel-default">
                    ...
                    <?php include_view(['name'=>'home/api/tab','tab'=>'home'])?>
