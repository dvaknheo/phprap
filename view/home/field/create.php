<?php include_view(['name'=>'home/public/header','title'=>'添加字段'])?>
<style>
            ...
            <tr class="js_headerClone">
                ...
                <td>
                    <select onchange="selectType(this)" name="header[type][]" class="form-control js_type">
                        <?php foreach($field->fieldTypeLabels as $k => $v){?>
                ...
                <td>
                    <select name="header[required][]" class="form-control js_required">
                        <?php foreach($field->requiredLabels as $k => $v){?>
                        <option value="<?=$k?>"><?=$v?></option>
                        <?php }?>
                    </select>
                </td>
                                                ...
                                                <table class="table" id="headerParamTable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select onchange="selectType(this)" name="header[type][]" class="form-control js_type">
                                                                <?php foreach($field->fieldTypeLabels as $k => $v){?>
                                                                <option <?php if($header->type == $k1){?>selected<?php }?> value="<?=$k?>"><?=$v?></option>
                                                                <?php }?>
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <select name="header[required][]" class="form-control">
                                                                <?php foreach($field->requiredLabels as $k => $v){?>
                                                                <option <?php if($header->required == $k){?>selected<?php }?> value="<?=$k?>"><?=$v?></option>
                                                                <?php }?>
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="addField(this, 'header')" href="javascript:;" class="btn btn-xs hidden-xs fa fa-fw fa-plus option-btn js_addField" data-toggle="tooltip" data-placement="bottom" data-title="添加子参数" <?php if(!$field->isCompositeType($header->type)){?>disabled<?php }?> data-parent_id="<?=$header->id?>"></a>
                                                        </td>
                                                ...
                                                <table class="table" id="requestParamTable">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select onchange="selectType(this)" name="request[type][]" class="form-control js_type">
                                                                <?php foreach($field->fieldTypeLabels as $k => $v){?>
                                                                <option <?php if($request->type == $k){?>selected<?php }?> value="<?=$k?>"><?=$v?></option>
                                                                <?php }?>
                                                            </select>
                                                        </td>
                                                        <td>
                                                            <select name="request[required][]" class="form-control">
                                                                <?php foreach($field->requiredLabels as $k => $v){?>
                                                                <option <?php if($request->required == $k){?>selected<?php }?> value="<?=$k?>"><?=$v?></option>
                                                                <?php }?>
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td>
                                                            <a onclick="deleteField(this)" href="javascript:;" class="btn btn-xs hidden-xs fa fa-fw fa-trash-o option-btn" data-toggle="tooltip" data-placement="bottom" data-title="删除参数"></a>
                                                            <a onclick="addField(this, 'request')" href="javascript:;" class="btn btn-xs hidden-xs fa fa-fw fa-plus option-btn js_addField" data-toggle="tooltip" data-placement="bottom" data-title="添加子参数" <?php if(!$field->isCompositeType($request->type)){?>disabled<?php }?> data-parent_id="<?=$request->id?>"></a>
                                                        </td>
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table class="table" id="responseParamTable">
                                                    ...
                                                    <?php foreach($template->responseAttributes as $k=>$response){?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <select onchange="selectType(this)" name="response[type][]" class="form-control js_type">
                                                                <?php foreach($field->fieldTypeLabels as $k => $v){?>
                                                                <option <?php if($response->type == $k){?>selected<?php }?> value="<?=$k?>"><?=$v?></option>
                                                                <?php }?>
                                                            </select>
                                                        </td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a onclick="addField(this, 'response')" href="javascript:;" class="btn btn-xs hidden-xs fa fa-fw fa-plus option-btn js_addField" data-toggle="tooltip" data-placement="bottom" data-title="添加子参数" <?php if(!$field->isCompositeType($response->type)){?>disabled<?php }?> data-parent_id="<?=$response->id?>"></a>
                                                        </td>
...
<script>
    ...
    $(function(){
        <?php if(Yii::$app->request->queryParams['from'] != 'template'){?>
        confirm('是否需要导入项目模板字段？', function(){
            window.location.href = "<?=url('', ['from' => 'template'])?>";
        });
        <?php }?>
