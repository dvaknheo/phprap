<?php include_view(['name'=>'home/public/header','title'=>'编辑字段'])?>
<style>
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table class="table" id="headerParamTable">
                                                    ...
                                                    <?php foreach($field->headerAttributes as $header){?>
                                                    <tr>
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table class="table" id="requestParamTable">
                                                    ...
                                                    <?php foreach($field->requestAttributes as $request){?>
                                                    <tr>
                                        ...
                                        <div class="panel-body">
                                            <div class="table-responsive">
                                                <table class="table" id="responseParamTable">
                                                    ...
                                                    <?php foreach($field->responseAttributes as $k=>$response){?>
                                                    <tr>
