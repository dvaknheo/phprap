...
<div class="container">
    ...
    <div class="row">
        ...
        <form role="form" action="<?=url()?>" method="post">
            ...
            <div class="form-group">
                <label>模板权限</label>
                <input type="hidden" class="js_templateRule" name="CreateMember[template_rule]">
                <label class="checkbox-inline">
                    <input class="js_templateRule" checked type="checkbox" value="look">查看模板
                </label>
                <label class="checkbox-inline">
                    <input class="js_templateRule" type="checkbox" value="create">新增模板
                </label>
                <label class="checkbox-inline">
                    <input class="js_templateRule" type="checkbox" value="update">编辑模板
                </label>
            </div>
