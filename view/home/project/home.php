<?php include_view(['name'=>'home/public/header','title'=>'项目主页'])?>
            ...
            <div class="col-lg-12">
                <div class="page-header">
                    ...
                    <div class="opt-btn">
                        ...
                        <?php if($project->hasAuth(['project' => 'delete,export,transfer']) || $project->isJoiner()){?>
                        <div class="btn-group hidden-xs ml-1">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right" role="menu">
                                ...
                                <?php if($project->hasAuth(['project' => 'export'])){?>
                                <li>
                                ...
                                <?php if($project->hasAuth(['project' => 'transfer'])){?>
                                <li>
                                ...
                                <li>
                                    <a href="javascript:;" class="hidden-xs" data-modal="#js_popModal" data-height="290" data-title="删除项目" data-src="<?=url('delete', ['id' => $project->encode_id])?>"><i class="fa fa-fw fa-trash-o"></i> 删除项目</a>
                                </li>
                                <?php }?>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <?php include_view(['name'=>'home/project/tab','tab'=>'home'])?>
