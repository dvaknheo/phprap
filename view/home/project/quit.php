<?php include_view(['name'=>'home/public/header','title'=>'退出项目'])?>
<style>
    body {
    ...
    <div class="row">
        <form role="form" action="<?=url()?>" method="post">
            ...
            <div class="form-group">
                <input name="QuitProject[password]" type="password" class="form-control js_password" placeholder="重要操作，请输入登录密码" datatype="*" nullmsg="重要操作，请输入登录密码" errormsg="请输入正确的登录密码!">
            </div>
