<?php include_view(['name'=>'home/public/header','title'=>'安全设置'])?>
...
<div id="wrapper">
    ...
    <!-- Navigation -->
    <?php include_view(['name'=>'home/public/nav','sidebar'=>'admin/public/sidebar','active'=>'config'])?>
    <div id="page-wrapper">
        <div class="row">
            <div class="col-lg-12">
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <?php include_view(['name'=>'admin/setting/tab','tab'=>'safe'])?>
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?=url('')?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="Config[register_captcha]" <?php if($config->register_captcha == 1){?>checked<?php }?> value=1 > 开启
                                    </label>

                                    <label class="radio-inline">
                                        <input type="radio" name="Config[register_captcha]" <?php if($config->register_captcha == 0){?>checked<?php }?> value=0> 关闭
                                    </label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="Config[login_captcha]" <?php if($config->login_captcha == 1){?>checked<?php }?> value="1"> 开启
                                    </label>

                                    <label class="radio-inline">
                                        <input type="radio" name="Config[login_captcha]" <?php if($config->login_captcha == 0){?>checked<?php }?> value="0"> 关闭
                                    </label>
