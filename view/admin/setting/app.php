<?php include_view(['name'=>'home/public/header','title'=>'系统设置'])?>
        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                ...
                <div class="panel panel-default">
                    ...
                    <?php include_view(['name'=>'admin/setting/tab','tab'=>'app'])?>
                    ...
                    <div class="panel-body">
                        <form role="form" action="<?=url('')?>" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="Config[export_time]" value="<?=$config->export_time??0?>" placeholder="导出文档的时间间隔，单位秒，填写0代表不限制导出频率" value="0" datatype="n" min="10" nullmsg="请输入导出间隔" errormsg="必须是数字">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label class="radio-inline">
                                        <input type="radio" name="Config[is_push]" <?php if($config->is_push == 1){?>checked<?php }?> value=1 > 开启
                                    </label>
                                    <label class="radio-inline">
                                        <input type="radio" name="Config[is_push]" <?php if($config->is_push == 0){?>checked<?php }?> value=0> 关闭
                                    </label>
                                </div>
                            </div>
