<?php include_view(['name'=>'install/public/header','title'=>'数据库配置——安装步骤二'])?>
        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="install-panel panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title text-center">PHPRAP V<?=APP_VERSION?> 安装步骤二</h3>
                </div>
                <div class="panel-body">

                    <?php include_view(['name'=>'install/public/nav','step'=>2])?>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <form class="form-horizontal" id="js_step2Form" role="form" action="<?=url('home/install/step2')?>" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" name="Step2[dbname]" class="form-control" datatype="*" value="phprap" placeholder="不存在会自动创建">
                                            </div>
                                        </div>
...
<?php include_view(['name'=>'install/public/footer'])?>
