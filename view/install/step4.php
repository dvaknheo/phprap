<?php include_view(['name'=>'install/public/header','title'=>'创建数据表——安装步骤四'])?>
</head>
            ...
            <div class="col-md-10 col-md-offset-1">
                <div class="install-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title text-center">PHPRAP V<?=APP_VERSION?> 安装步骤四</h3>
                    </div>
                    <div class="panel-body">

                        <?php include_view(['name'=>'install/public/nav','step'=>4])?>
                                ...
                                <div class="panel panel-default">
                                    <div class="panel-body">
                                        ...
                                        <div class="alert alert-warning fade in hidden js_success">
                                            <strong>恭喜您，PHPRAP V<?=APP_VERSION?>已经安装成功，如果您要重新安装，请先删除runtime/install/install.lock文件。</strong>
                                        </div>
